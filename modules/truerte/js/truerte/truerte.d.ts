...
type TextCaseMode = 'lowercase' | 'uppercase' | 'titlecase';
...
declare class Editor implements EditorObservable {
    ...
    toggleBulletList(styleType?: string): boolean;
    toggleNumberedList(styleType?: string): boolean;
    outdent(): boolean;
    indent(): boolean;
    alignLeft(): boolean;
    alignCenter(): boolean;
    ...
    setTextCase(mode: TextCaseMode): boolean;
    setLetterSpacing(value: string | number): boolean;
    setParagraphSpacing(position: ParagraphSpacingPosition, action: ParagraphSpacingAction): boolean;
    addParagraphSpacingBefore(): boolean;
    addParagraphSpacingAfter(): boolean;
    removeParagraphSpacingBefore(): boolean;
    removeParagraphSpacingAfter(): boolean;
    openLinkDialog(): boolean;
    insertLink(link: string | Record<string, unknown>): boolean;
    removeLink(): boolean;
    openCodeEditor(): boolean;
    insertTable(rows: number, columns: number): boolean;
    setBlock(format: string): boolean;
...
interface TrueRTE extends EditorManager {
    geom: {
        Rect: Rect;
    };
    util: {
