...
/* Go backwards over all attributes; safely remove bad ones */for(;s--;){const r=t[s],{name:a,namespaceURI:i,value:l}=r,c=_e(a);let d="value"===a?l:vf(l);
/* Execute a hook if present */
...
/* Is `value` valid for this attribute? */;const u=_e(e.nodeName);if(Pe(u,c,d)){
/* Handle attributes that require Trusted Types */
if(w&&"object"==typeof p&&"function"==typeof p.getAttributeType)if(i);else switch(p.getAttributeType(u,c)){case"TrustedHTML":d=w.createHTML(d);break;case"TrustedScriptURL":d=w.createScriptURL(d)}
/* Handle invalid data-* attribute set by try-catching it */try{i?e.setAttributeNS(i,a,d):
/* Fallback to setAttribute() for browser-unrecognized namespaces e.g. "x-schema". */
e.setAttribute(a,d),ze(e)?Ie(e):df(o.removed)}catch(e){}}}
