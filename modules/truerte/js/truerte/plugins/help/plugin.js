...
(function () {
    ...
    var global$4 = truerte.util.Tools.resolve('truerte.PluginManager');
    ...
    var global$3 = truerte.util.Tools.resolve('truerte.Resource');

    var global$2 = truerte.util.Tools.resolve('truerte.util.I18n');

    const pLoadHtmlByLangCode = (baseUrl, langCode) => global$3.load(`truerte.html-i18n.help-keynav.${ langCode }`, `${ baseUrl }/js/i18n/keynav/${ langCode }.js`);
    ...
    var global$1 = truerte.util.Tools.resolve('truerte.Env');
    ...
    const tab$1 = editor => {
      ...
      const getPluginData = (editor, key) => find(urls, x => {
        ...
        const html = makeLink({
          name: x.name,
          url: `https://www.truerte.org/docs/truerte/1/${ x.slug }/`
        });
        return {
          name: x.name,
          html
    ...
    var global = truerte.util.Tools.resolve('truerte.EditorManager');
    ...
    const tab = () => {
      ...
      const changeLogLink = '<a data-alloy-tabstop="true" tabindex="-1" href="https://truerte.org/docs/truerte/1/changelog/?utm_campaign=help_dialog_version_tab&utm_source=editor&utm_medium=referral" rel="noopener" target="_blank">TrueRTE ' + version + '</a>';
      const htmlPanel = {
        type: 'htmlpanel',
