...
(function () {
    ...
    var global$5 = truerte.util.Tools.resolve('truerte.PluginManager');
    ...
    var global$4 = truerte.util.Tools.resolve('truerte.util.Tools');
    ...
    var global$3 = truerte.util.Tools.resolve('truerte.dom.TreeWalker');

    var global$2 = truerte.util.Tools.resolve('truerte.util.URI');
    ...
    var global$1 = truerte.util.Tools.resolve('truerte.util.Delay');
    ...
    var global = truerte.util.Tools.resolve('truerte.util.VK');
