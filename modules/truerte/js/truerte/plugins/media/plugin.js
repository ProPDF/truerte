...
(function () {
    ...
    var global$6 = truerte.util.Tools.resolve('truerte.PluginManager');
    ...
    var global$5 = truerte.util.Tools.resolve('truerte.util.Tools');

    var global$4 = truerte.util.Tools.resolve('truerte.dom.DOMUtils');

    var global$3 = truerte.util.Tools.resolve('truerte.html.DomParser');
    ...
    var global$2 = truerte.util.Tools.resolve('truerte.html.Node');

    var global$1 = truerte.util.Tools.resolve('truerte.html.Serializer');
    ...
    var global = truerte.util.Tools.resolve('truerte.Env');
