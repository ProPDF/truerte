...
(function () {
    ...
    var global$3 = truerte.util.Tools.resolve('truerte.util.Delay');

    var global$2 = truerte.util.Tools.resolve('truerte.util.LocalStorage');

    var global$1 = truerte.util.Tools.resolve('truerte.util.Tools');
    ...
    const register$1 = editor => {
      ...
      registerOption('autosave_prefix', {
        processor: 'string',
        default: 'truerte-autosave-{path}{query}{hash}-{id}-'
      });
