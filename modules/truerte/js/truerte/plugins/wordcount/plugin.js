...
(function () {
    ...
    var global$2 = truerte.util.Tools.resolve('truerte.PluginManager');
    ...
    var global$1 = truerte.util.Tools.resolve('truerte.dom.TreeWalker');
    ...
    var global = truerte.util.Tools.resolve('truerte.util.Delay');
