...
(function () {
    ...
    var global$3 = truerte.util.Tools.resolve('truerte.PluginManager');
    ...
    var global = truerte.util.Tools.resolve('truerte.FakeClipboard');

    const tableTypeBase = 'x-truerte/dom-table-';
