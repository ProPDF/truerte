...
(function () {
    ...
    var global$7 = truerte.util.Tools.resolve('truerte.PluginManager');
    ...
    var global$6 = truerte.util.Tools.resolve('truerte.dom.RangeUtils');

    var global$5 = truerte.util.Tools.resolve('truerte.dom.TreeWalker');

    var global$4 = truerte.util.Tools.resolve('truerte.util.VK');
    ...
    var global$3 = truerte.util.Tools.resolve('truerte.dom.DOMUtils');

    var global$2 = truerte.util.Tools.resolve('truerte.util.Tools');
    ...
    var global$1 = truerte.util.Tools.resolve('truerte.dom.BookmarkManager');
    ...
    var global = truerte.util.Tools.resolve('truerte.html.Node');
