...
import { TableEventData } from 'truerte/core/api/EventTypes';
import * as FakeClipboard from 'truerte/plugins/table/api/Clipboard';
import TablePlugin from 'truerte/plugins/table/Plugin';

import * as TableTestUtils from '../module/test/TableTestUtils';

describe('browser.truerte.plugins.table.ClipboardTest', () => {
  ...
  it('TINY-8568: should correctly copy and paste colgroup table with complex selection', () => {
    ...
    assert.equal(dataTransfer.getData('text/html'), '<!-- x-truerte/html -->' + expectedTable);
