...
import * as DataToHtml from 'truerte/plugins/media/core/DataToHtml';
import { MediaData } from 'truerte/plugins/media/core/Types';
import Plugin from 'truerte/plugins/media/Plugin';

describe('browser.truerte.plugins.media.core.DataToHtmlTest', () => {
