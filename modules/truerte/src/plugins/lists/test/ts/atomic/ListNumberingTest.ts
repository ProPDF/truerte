...
import { parseStartValue, parseDetail, ListDetail } from 'truerte/plugins/lists/core/ListNumbering';

describe('atomic.truerte.plugins.lists.core.ListNumberingTest', () => {
