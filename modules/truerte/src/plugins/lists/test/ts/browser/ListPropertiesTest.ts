...
import { ExecCommandEvent } from 'truerte/core/api/EventTypes';
import { EditorEvent } from 'truerte/core/api/util/EventDispatcher';
import Plugin from 'truerte/plugins/lists/Plugin';

describe('browser.truerte.plugins.lists.ListPropertiesTest', () => {
  ...
  const contentMenuSelector = '.tox-truerte-aux .tox-menu .tox-collection__item:contains("List properties...")';
