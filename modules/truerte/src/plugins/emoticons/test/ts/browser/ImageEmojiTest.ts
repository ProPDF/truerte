...
describe.skip('browser.truerte.plugins.emoticons.ImageEmojiTest', () => {
  const hook = TinyHooks.bddSetupLight<Editor>({
    plugins: 'emoticons',
    toolbar: 'emoticons',
    base_url: '/project/truerte/js/truerte',
    emoticons_database_url: '/project/truerte/src/plugins/emoticons/main/js/emojiimages.js',
    setup: () => {
      Resource.unload('truerte.plugins.emoticons');
    }
  }, [ Plugin ], true);
