...
import Env from 'truerte/core/api/Env';
import Plugin from 'truerte/plugins/template/Plugin';
import { getPreviewContent } from 'truerte/plugins/template/ui/Dialog';
...
const noCorsNoStyle = '<!DOCTYPE html><html><head>' +
  `<base href="http://${host}/">` +
  `<link type="text/css" rel="stylesheet" href="http://${host}/project/truerte/js/truerte/skins/ui/oxide/content.min.css">` +
  `<link type="text/css" rel="stylesheet" href="http://${host}/project/truerte/js/truerte/skins/content/default/content.css">` +
...
const corsNoStyle = '<!DOCTYPE html><html><head>' +
  `<base href="http://${host}/">` +
  `<link type="text/css" rel="stylesheet" href="http://${host}/project/truerte/js/truerte/skins/ui/oxide/content.min.css" crossorigin="anonymous">` +
  `<link type="text/css" rel="stylesheet" href="http://${host}/project/truerte/js/truerte/skins/content/default/content.css" crossorigin="anonymous">` +
  '<script>document.addEventListener && document.addEventListener("click", function(e) {for (var elm = e.target; elm; elm = elm.parentNode) {if (elm.nodeName === "A" && !(' +
  metaKey +
...
describe.skip('browser.truerte.plugins.template.Dialog.getPreviewContent', () => {
