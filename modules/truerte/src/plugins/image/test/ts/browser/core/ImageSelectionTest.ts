...
import { ImageData } from 'truerte/plugins/image/core/ImageData';
import { insertOrUpdateImage } from 'truerte/plugins/image/core/ImageSelection';
import Plugin from 'truerte/plugins/image/Plugin';

describe('browser.truerte.plugins.image.core.ImageSelectionTest', () => {
