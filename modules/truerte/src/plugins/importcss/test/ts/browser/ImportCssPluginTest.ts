...
import Plugin from 'truerte/plugins/importcss/Plugin';
...
describe('browser.truerte.plugins.importcss.ImportCssTest', () => {
  before(() => {
    Plugin();
  });
  ...
  it('TBA: content_css with one file, append default', () => pTestEditorWithSettings(
    ...
    {
      content_css: [ '/project/truerte/src/plugins/importcss/test/css/basic.css' ],
  ...
  it('TBA: content_css with multiple files, append true', () => pTestEditorWithSettings(
    ...
    {
      content_css: [
        '/project/truerte/src/plugins/importcss/test/css/basic.css',
        '/project/truerte/src/plugins/importcss/test/css/advanced.css',
        '/project/truerte/src/plugins/importcss/test/css/other-adv.css'
      ],
      importcss_append: true
    }
  ));
  ...
  it('TINY-8238: content_css with two files, basic and internal CSS classes', () => pTestEditorWithSettings(
    ...
    },
    {
      content_css: [
        '/project/truerte/src/plugins/importcss/test/css/basic.css',
        '/project/truerte/src/plugins/importcss/test/css/internal.css'
      ],
      importcss_append: undefined
    }
  ));
