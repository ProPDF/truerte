...
import AutoresizePlugin from 'truerte/plugins/autoresize/Plugin';
import FullscreenPlugin from 'truerte/plugins/fullscreen/Plugin';

describe('browser.truerte.plugins.autoresize.AutoresizePluginTest', () => {
  ...
  context('common tests', () => {
    ...
    it('TBA: Editor size increase with async loaded content', async () => {
      ...
      editor.dom.setAttrib(image, 'src', 'http://moxiecode.cachefly.net/truerte/v9/images/logo.png');
