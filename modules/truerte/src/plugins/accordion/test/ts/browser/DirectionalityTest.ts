...
import AccordionPlugin from 'truerte/plugins/accordion/Plugin';
import DirectionalityPlugin from 'truerte/plugins/directionality/Plugin';

describe('browser.truerte.plugins.accordion.DirectionalityTest', () => {
