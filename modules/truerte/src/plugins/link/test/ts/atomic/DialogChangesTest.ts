...
import { DialogChanges, DialogDelta } from 'truerte/plugins/link/ui/DialogChanges';
import { LinkDialogCatalog, LinkDialogData, ListItem } from 'truerte/plugins/link/ui/DialogTypes';

const tOptional = OptionalInstances.tOptional;

describe('browser.truerte.plugins.link.DialogChangesTest', () => {
  context('getDelta', () => {
