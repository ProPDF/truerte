...
describe('browser.truerte.plugins.link.SelectedLinkTest', () => {
  ...
  it('TBA: should not get anchor info if not selected node', async () => {
    ...
    editor.setContent('<p><a href="http://truerte.com">tiny</a></p>');
  ...
  it('TINY-4867: link should not be active when multiple links or plain text selected', async () => {
    const editor = hook.editor();
    editor.setContent('<p><a href="http://truerte.com">a</a> b <a href="http://truerte.com">c</a></p>');
