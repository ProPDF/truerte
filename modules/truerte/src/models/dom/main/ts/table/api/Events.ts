...
import { NewTableCellEvent, NewTableRowEvent, TableEventData } from 'truerte/core/api/EventTypes';
import { EditorEvent } from 'truerte/core/api/util/EventDispatcher';

// Duplicated in modules/truerte/src/themes/silver/main/ts/ui/selector/TableSelectorHandles.ts
