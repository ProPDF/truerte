...
const registerCommands = (editor: Editor, actions: TableActions): void => {
  ...
  // trueRTE.activeEditor.execCommand('mceTableApplyCellStyle', false, { backgroundColor: 'red', borderColor: 'blue' })
  // Remove cell style using command (an empty string indicates to remove the style)
  // trueRTE.activeEditor.execCommand('mceTableApplyCellStyle', false, { backgroundColor: '' })
