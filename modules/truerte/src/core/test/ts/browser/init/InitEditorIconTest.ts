...
import IconManager from 'truerte/core/api/IconManager';

describe('browser.truerte.core.init.InitEditorIconTest', () => {
  const overrideIcon = '<svg>override-icon</svg>';
  const hook = TinyHooks.bddSetupLight<Editor>({
    icons: 'custom',
    icons_url: '/project/truerte/src/core/test/assets/icons/custom/icons.js',
