...
describe('browser.truerte.core.dom.StyleSheetLoaderTest', () => {
  const contentCss = '/project/truerte/js/truerte/skins/content/default/content.css';
  const skinCss = '/project/truerte/js/truerte/skins/ui/oxide/skin.css';
