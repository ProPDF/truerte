...
describe('browser.truerte.core.dom.ContentCssCorsTest', () => {
  const settings = {
  ...
  context('Classic mode: Editor StyleSheetLoader is separate from global (truerte)', () => {
  ...
  context('Inline mode: Global (truerte) StyleSheetLoader is shared amongst multiple inline editors', () => {
  ...
  context('Classic and inline editors: Global (truerte) StyleSheetLoader is shared amongst multiple inline editors, but classic editor has separate stylesheetloader', () => {
