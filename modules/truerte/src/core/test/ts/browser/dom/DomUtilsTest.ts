...
describe('browser.truerte.core.dom.DOMUtilsTest', () => {
  ...
  it('loadCSS', () => {
    ...
    DOM.loadCSS('truerte/dom/test.css?a=1,truerte/dom/test.css?a=2,truerte/dom/test.css?a=3');
  ...
  it('loadCSS contentCssCors enabled', () => {
    ...
    CustomDOM.loadCSS('truerte/dom/test_cors.css?a=1,truerte/dom/test_cors.css?a=2,truerte/dom/test_cors.css?a=3');
  ...
  it('isEmpty', () => {
    ...
    DOM.setHTML('test', '<img src="truerte/ui/img/raster.gif">');
    assert.isFalse(DOM.isEmpty(getTestElement()));
