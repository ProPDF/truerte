...
import { UploadResult } from 'truerte/core/api/EditorUpload';
import Env from 'truerte/core/api/Env';
import { BlobInfo } from 'truerte/core/api/file/BlobCache';
...
describe('browser.truerte.core.EditorUploadTest', () => {
