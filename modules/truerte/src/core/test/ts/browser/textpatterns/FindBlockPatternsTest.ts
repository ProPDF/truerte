...
import * as BlockPattern from 'truerte/core/textpatterns/core/BlockPattern';
import { DynamicPatternContext, PatternSet } from 'truerte/core/textpatterns/core/PatternTypes';
import { getParentBlock, resolveFromDynamicPatterns } from 'truerte/core/textpatterns/utils/Utils';

import { getPatternSetFor } from '../../module/test/TextPatternsUtils';

// Similar to modules/truerte/src/core/test/ts/atomic/textpatterns/FindBlockPatternsTest.ts
// but uses DOM and includes tests for text_patterns_lookup
describe('browser.truerte.textpatterns.FindBlockPatternsTest', () => {
