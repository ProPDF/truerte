...
import * as InlinePattern from 'truerte/core/textpatterns/core/InlinePattern';
import {
  DynamicPatternContext, InlinePattern as InlinePatternType, InlinePatternMatch, PatternSet
} from 'truerte/core/textpatterns/core/PatternTypes';
import { PathRange } from 'truerte/core/textpatterns/utils/PathRange';
import { getBeforeText, getParentBlock, resolveFromDynamicPatterns } from 'truerte/core/textpatterns/utils/Utils';
import ListsPlugin from 'truerte/plugins/lists/Plugin';

import { getPatternSetFor } from '../../module/test/TextPatternsUtils';

describe('browser.truerte.textpatterns.FindInlinePatternTest', () => {
