...
import { SpotPoint } from 'truerte/core/alien/Spot';
import * as TextSearch from 'truerte/core/alien/TextSearch';
import Editor from 'truerte/core/api/Editor';

describe('browser.truerte.core.textpatterns.TextSearchTest', () => {
