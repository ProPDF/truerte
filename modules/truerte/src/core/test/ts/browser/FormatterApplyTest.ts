...
describe('browser.truerte.core.FormatterApplyTest', () => {
  ...
  it('Bug #5134 - TrueRTE removes formatting tags in the getContent', () => {
    const editor = hook.editor();
    editor.setContent('');
    editor.formatter.register('format', {
      inline: 'strong',
    ...
    editor.formatter.apply('format');
    assert.equal(getContent(editor), '', 'empty TrueRTE');
    editor.selection.setContent('a');
    assert.equal(getContent(editor), '<p><strong>a</strong></p>', 'bold text inside TrueRTE');
  });

  it('Bug #5134 - TrueRTE removes formatting tags in the getContent - typing', () => {
    const editor = hook.editor();
    editor.setContent('');
    editor.formatter.register('format', {
      inline: 'strong',
