...
import { AutocompleterEventArgs, AutocompleteLookupData } from 'truerte/core/autocomplete/AutocompleteTypes';

describe('browser.truerte.core.keyboard.AutocompleterTest', () => {
