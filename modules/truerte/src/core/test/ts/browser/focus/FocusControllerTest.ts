...
import FocusManager from 'truerte/core/api/FocusManager';
import * as FocusController from 'truerte/core/focus/FocusController';

describe('browser.truerte.core.focus.FocusControllerTest', () => {
  Arr.each([
