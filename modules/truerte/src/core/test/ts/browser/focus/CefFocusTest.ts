...
describe('browser.truerte.core.focus.CefFocusTest', () => {
  ...
  it('Focus editors', async () => {
    const editor1 = await pCreateInlineEditor('<div class="truerte"><p contenteditable="false">a</p></div>');
    const editor2 = await pCreateInlineEditor('<div class="truerte"><p contenteditable="false">b</p></div>');
