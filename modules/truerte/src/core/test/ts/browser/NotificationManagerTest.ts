...
import { BeforeOpenNotificationEvent, OpenNotificationEvent } from 'truerte/core/api/EventTypes';
import { NotificationSpec } from 'truerte/core/api/NotificationManager';

describe('browser.truerte.core.NotificationManagerTest', () => {
  Arr.each([
