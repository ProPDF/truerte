...
} from 'truerte/core/bookmark/BookmarkTypes';
import * as GetBookmark from 'truerte/core/bookmark/GetBookmark';
import * as ResolveBookmark from 'truerte/core/bookmark/ResolveBookmark';

describe('browser.truerte.core.bookmark.BookmarksTest', () => {
