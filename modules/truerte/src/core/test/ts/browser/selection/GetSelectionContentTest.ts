...
import { BeforeGetContentEvent } from 'truerte/core/api/EventTypes';
import { EditorEvent } from 'truerte/core/api/util/EventDispatcher';
import { GetSelectionContentArgs } from 'truerte/core/content/ContentTypes';
import { getContent } from 'truerte/core/selection/GetSelectionContent';

describe('browser.truerte.selection.GetSelectionContentTest', () => {
