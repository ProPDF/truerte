...
describe('browser.truerte.core.EditorManagerTest', () => {
  ...
  it('get', (done) => {
    viewBlock.update('<textarea class="truerte"></textarea>');
    EditorManager.init({
    ...
    EditorManager.init({
      ...
      init_instance_callback: (editor1) => {
        setTimeout(() => {
          ...
          EditorManager.init({
            selector: 'textarea',
            skin_url: '/project/truerte/js/truerte/skins/ui/oxide',
            content_css: '/project/truerte/js/truerte/skins/content/default',
