...
import { FakeCaret, isFakeCaretTarget } from 'truerte/core/caret/FakeCaret';
import { isFakeCaretTableBrowser } from 'truerte/core/keyboard/TableNavigation';
import * as Zwsp from 'truerte/core/text/Zwsp';

import * as CaretAsserts from '../../module/test/CaretAsserts';
import * as ViewBlock from '../../module/test/ViewBlock';

describe('browser.truerte.core.caret.FakeCaretTest', () => {
