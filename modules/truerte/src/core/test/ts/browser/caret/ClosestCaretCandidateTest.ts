...
import { FakeCaretPosition, closestCaretCandidateNodeRect, closestFakeCaretCandidate } from 'truerte/core/caret/ClosestCaretCandidate';
...
describe('browser.truerte.core.ClosestCaretCandidateTest', () => {
