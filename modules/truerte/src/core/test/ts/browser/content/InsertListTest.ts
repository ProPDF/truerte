...
import DomParser from 'truerte/core/api/html/DomParser';
import AstNode from 'truerte/core/api/html/Node';
import Schema from 'truerte/core/api/html/Schema';
import * as InsertList from 'truerte/core/content/InsertList';

describe('browser.truerte.core.content.InsertListTest', () => {
  const schema = Schema({});
