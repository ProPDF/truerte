...
const Quirks = (editor: Editor): Quirks => {
   ...
   * left there. TrueRTE sees a floating text node and wraps it in a paragraph on the key up event (ForceBlocks.js
  ...
  /**
   * WebKit will produce DIV elements here and there by default. But since TrueRTE uses paragraphs by
