 ...
 *
 * @private
 * @class truerte.caret.CaretWalker
 * @example
...
export const CaretWalker = (root: Node): CaretWalker => ({
  /**
     ...
     *
     * @method next
     * @param {truerte.caret.CaretPosition} caretPosition Caret position to start from.
     * @return {truerte.caret.CaretPosition} CaretPosition or null if no position was found.
     */
  next: (caretPosition: CaretPosition | null): CaretPosition | null => {
