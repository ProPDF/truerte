 ...
 * @private
 * @static
 * @class truerte.caret.CaretBookmark
 * @example
...
export {
   ...
   * @param {truerte.caret.CaretPosition} caretPosition Caret position within the root node.
   ...
   * @return {truerte.caret.CaretPosition} Caret position resolved from xpath like bookmark.
   */
  resolve
};
