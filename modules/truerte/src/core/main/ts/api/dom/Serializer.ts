...
/**
 * This class is used to serialize DOM trees into a string. Consult the TrueRTE API Documentation for
 * more details and examples on how to use this class.
 *
 * @class truerte.dom.Serializer
 */
...
const DomSerializer = (settings: DomSerializerSettings, editor?: Editor): DomSerializer => {
  ...
  return {
     ...
     *
     * @field {truerte.html.Schema} schema
     */
     ...
     * Consult the TrueRTE Documentation for more details on this format.
     *
     * @method addRules
