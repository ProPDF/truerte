 ...
 *
 * @class truerte.dom.DOMUtils
 * @example
 * // Add a class to an element by id in the page
 * truerte.DOM.addClass('someid', 'someclass');
 *
 * // Add a class to an element by id inside the editor
 * truerte.activeEditor.dom.addClass('someid', 'someclass');
 */
...
/**
 * Constructs a new DOMUtils instance. Consult the TrueRTE Documentation for more details on settings etc for this class.
 *
 * @private
 * @constructor
 * @method DOMUtils
...
const DOMUtils = (doc: Document, settings: Partial<DOMUtilsSettings> = {}): DOMUtils => {
  ...
  const self: DOMUtils = {
     ...
     * truerte.activeEditor.dom.addClass(truerte.activeEditor.dom.select('p'), 'someclass');
     *
     * // Adds a class to all spans that have the test class in the currently active editor
     * truerte.activeEditor.dom.addClass(truerte.activeEditor.dom.select('span.test'), 'someclass')
     */
    select,
     ...
     * truerte.activeEditor.dom.add(truerte.activeEditor.getBody(), 'p', { title: 'my title' }, 'Some content');
     */
    add,
     ...
     * var el = truerte.activeEditor.dom.create('div', { id: 'test', 'class': 'myclass' }, 'some content');
     * truerte.activeEditor.selection.setNode(el);
     */
    create,
     ...
     * truerte.activeEditor.selection.setContent(truerte.activeEditor.dom.createHTML('a', { href: 'test.html' }, 'some line'));
     */
    createHTML,
     ...
     * truerte.activeEditor.dom.remove(truerte.activeEditor.dom.select('p'));
     *
     * // Removes an element by id in the document
     * truerte.DOM.remove('mydiv');
     */
    remove,
     ...
     * truerte.activeEditor.dom.setStyle(truerte.activeEditor.dom.select('p'), 'background-color', 'red');
     *
     * // Sets a style value to an element by id in the current document
     * truerte.DOM.setStyle('mydiv', 'background-color', 'red');
     */
    setStyle,
     ...
     * truerte.activeEditor.dom.setStyles(truerte.activeEditor.dom.select('p'), { 'background-color': 'red', 'color': 'green' });
     *
     * // Sets styles to an element by id in the current document
     * truerte.DOM.setStyles('mydiv', { 'background-color': 'red', 'color': 'green' });
     */
    setStyles,
     ...
     * truerte.activeEditor.dom.setAttrib(truerte.activeEditor.dom.select('p'), 'class', 'myclass');
     *
     * // Sets class attribute on a specific element in the current page
     * truerte.dom.setAttrib('mydiv', 'class', 'myclass');
     */
    setAttrib,
     ...
     * truerte.activeEditor.dom.setAttribs(truerte.activeEditor.dom.select('p'), { 'class': 'myclass', title: 'some title' });
     *
     * // Sets class and title attributes on a specific element in the current page
     * truerte.DOM.setAttribs('mydiv', { 'class': 'myclass', title: 'some title' });
     */
    setAttribs,
     ...
     * truerte.DOM.loadCSS('somepath/some.css');
     *
     * // Loads a CSS file into the currently active editor instance
     * truerte.activeEditor.dom.loadCSS('somepath/some.css');
     *
     * // Loads a CSS file into an editor instance by id
     * truerte.get('someid').dom.loadCSS('somepath/some.css');
     *
     * // Loads multiple CSS files into the current document
     * truerte.DOM.loadCSS('somepath/some.css,somepath/someother.css');
     */
    loadCSS,
     ...
     * truerte.activeEditor.dom.addClass(truerte.activeEditor.dom.select('p'), 'myclass');
     *
     * // Adds a class to a specific element in the current page
     * truerte.DOM.addClass('mydiv', 'myclass');
     */
    addClass,
     ...
     * truerte.activeEditor.dom.removeClass(truerte.activeEditor.dom.select('p'), 'myclass');
     *
     * // Removes a class from a specific element in the current page
     * truerte.DOM.removeClass('mydiv', 'myclass');
     */
    removeClass,
     ...
     * truerte.activeEditor.dom.setHTML(truerte.activeEditor.dom.select('p'), 'some inner html');
     *
     * // Sets the inner HTML of an element by id in the document
     * truerte.DOM.setHTML('mydiv', 'some inner html');
     */
    setHTML,
     ...
     * @example
     * truerte.DOM.getOuterHTML(editorElement);
     * truerte.activeEditor.getOuterHTML(truerte.activeEditor.getBody());
     */
    getOuterHTML,
     ...
     * truerte.activeEditor.dom.setOuterHTML(truerte.activeEditor.dom.select('p'), '<div>some html</div>');
     *
     * // Sets the outer HTML of an element by id in the document
     * truerte.DOM.setOuterHTML('mydiv', '<div>some html</div>');
     */
    setOuterHTML,
     ...
     * @example
     * truerte.DOM.isEmpty(node, { img: true });
     */
    isEmpty,

    /**
     * Creates a new DOM Range object. This will use the native DOM Range API if it's
     * available. If it's not, it will fall back to the custom TrueRTE implementation.
     *
     * @method createRng
     * @return {DOMRange} DOM Range object.
     * @example
     * const rng = truerte.DOM.createRng();
     ...
     * <br>
     * <em>Deprecated in TrueRTE 6.0 and has been marked for removal in TrueRTE 7.0. Use <code>dispatch</code> instead.</em>
     *
     * @method fire
