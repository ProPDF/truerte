...
/**
 * This mixin contains the event logic for the truerte.Editor class.
 *
 * @mixin truerte.EditorObservable
 * @extends truerte.util.Observable
 * @private
 */
 ...
 *
 * @private
 * @param {truerte.Editor} editor Editor instance to get event target from.
