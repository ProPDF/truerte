...
/**
 * This class handles the creation of TrueRTE's notifications.
 *
 * @class truerte.NotificationManager
 * @example
...
const NotificationManager = (editor: Editor): NotificationManager => {
  ...
  return {
     ...
     * <br /><br />
     * For information on the available settings, see: <a href="https://www.truerte.org/docs/truerte/1/creating-custom-notifications/">Create custom notifications</a>.
     */
    open,
