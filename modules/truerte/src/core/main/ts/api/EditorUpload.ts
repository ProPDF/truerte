...
/**
 * TrueRTE Editor Upload API
 * Handles image uploads, updates undo stack and patches over various internal functions.
 *
 * @class truerte.EditorUpload
 * @example
 * // Apply a new filter within the image scan.
 * truerte.activeEditor.EditorUpload.addFilter((image) => {
 ...
 * truerte.activeEditor.EditorUpload.uploadImages();
 *
 * // Scan the editor for valid images
 * truerte.activeEditor.EditorUpload.scanForImages();
 */
