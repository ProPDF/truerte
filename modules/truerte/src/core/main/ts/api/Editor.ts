...
/**
 * This class contains the core logic for a TrueRTE editor.
 *
 * @class truerte.Editor
 * @mixes truerte.util.Observable
 * @example
 * // Add a class to all paragraphs in the editor.
 * truerte.activeEditor.dom.addClass(truerte.activeEditor.dom.select('p'), 'someclass');
 *
 * // Gets the current editors selection as text
 * truerte.activeEditor.selection.getContent({ format: 'text' });
 *
 * // Creates a new editor instance
 * const ed = new truerte.Editor('textareaid', {
 *   some_setting: 1
 * }, truerte.EditorManager);
 *
 * ed.render();
 */
 ...
 *
 * @include ../../../../../tools/docs/truerte.Editor.js
 */
...
class Editor implements EditorObservable {
   ...
   * truerte.activeEditor.plugins.someplugin.someMethod();
   */
  public plugins: Record<string, Plugin> = {};

  /**
   * URI object to document configured for the TrueRTE instance.
   *
   * @property documentBaseURI
   * @type truerte.util.URI
   * @example
   * // Get relative URL from the location of document_base_url
   * truerte.activeEditor.documentBaseURI.toRelative('/somedir/somefile.htm');
   *
   * // Get absolute URL from the location of document_base_url
   * truerte.activeEditor.documentBaseURI.toAbsolute('somefile.htm');
   */
  public documentBaseURI: URI;

  /**
   * URI object to current document that holds the TrueRTE editor instance.
   *
   * @property baseURI
   * @type truerte.util.URI
   * @example
   * // Get relative URL from the location of the API
   * truerte.activeEditor.baseURI.toRelative('/somedir/somefile.htm');
   *
   * // Get absolute URL from the location of the API
   * truerte.activeEditor.baseURI.toAbsolute('somefile.htm');
   */
  public baseURI: URI;
   ...
   * @param {truerte.EditorManager} editorManager EditorManager instance.
   */
  ...
  /**
   * Focuses/activates the editor. This will set this editor as the activeEditor in the truerte collection
   ...
   * <br>
   * <em>Deprecated in TrueRTE 6.0 and has been marked for removal in TrueRTE 7.0. Use the <code>editor.options.get</code> API instead.</em>
   *
   * @method getParam
   ...
   * const someval = truerte.activeEditor.getParam('myvalue');
   *
   * // Returns a specific config value from a specific editor instance by id
   * const someval2 = truerte.get('my_editor').getParam('myvalue');
   */
   ...
   *
   * @method hasPlugin
   * @param {String} name The name of the plugin, as specified for the TrueRTE `plugins` option.
   ...
   * the truerte command identifiers documentation.
   *
   * @method execCommand
   ...
   * truerte.activeEditor.setProgressState(true);
   *
   * // Hide progress for the active editor
   * truerte.activeEditor.setProgressState(false);
   *
   * // Show progress after 3 seconds
   * truerte.activeEditor.setProgressState(true, 3000);
   */
   ...
   * <br>
   * <em>Note: The content return value was deprecated in TrueRTE 6.0 and has been marked for removal in TrueRTE 7.0.</em>
   *
   * @method setContent
   ...
   * truerte.activeEditor.setContent('<span>some</span> html');
   *
   * // Sets the content of a specific editor (my_editor in this example)
   * truerte.get('my_editor').setContent(data);
   *
   * // Sets the content of the activeEditor editor using the specified format
   * truerte.activeEditor.setContent('<p>Some html</p>', { format: 'html' });
   */
   ...
   * console.debug(truerte.activeEditor.getContent());
   *
   * // Get the contents of the currently active editor as plain text
   * truerte.activeEditor.getContent({ format: 'text' });
   *
   * // Get content of a specific editor:
   * truerte.get('content id').getContent()
   */
   ...
   * @example
   * if (truerte.activeEditor.isDirty()) {
  ...
  /**
   * Returns the target element/textarea that got replaced with a TrueRTE editor instance.
   *
   * @method getElement
  ...
  /**
   * Removes the editor from the dom and truerte collection.
   *
   * @method remove
   */
  public remove(): void {
