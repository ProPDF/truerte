...
/**
 * TrueRTE UI registration API.
 *
 * @class truerte.editor.ui.Registry
 */
const registry = (): Registry.Registry => {
  ...
  return {
     ...
     * <a href="https://www.truerte.org/docs/truerte/1/autocompleter/">
     ...
     * <a href="https://www.truerte.org/docs/truerte/1/custom-basic-toolbar-button/">
     ...
     * <a href="https://www.truerte.org/docs/truerte/1/contextform/">
     ...
     * <a href="https://www.truerte.org/docs/truerte/1/contextmenu/">
     ...
     * <a href="https://www.truerte.org/docs/truerte/1/contexttoolbar/">
     ...
     * TrueRTE UI components that can display an icon. The icon is only available
     ...
     * <a href="https://www.truerte.org/docs/truerte/1/custom-menu-toolbar-button/">
     ...
     * <a href="https://www.truerte.org/docs/truerte/1/creating-custom-menu-items/">
     ...
     * <a href="https://www.truerte.org/docs/truerte/1/custom-nested-menu-items/">
     ...
     * <a href="https://www.truerte.org/docs/truerte/1/customsidebar/">
     ...
     * <a href="https://www.truerte.org/docs/truerte/1/custom-split-toolbar-button/">
     ...
     * <a href="https://www.truerte.org/docs/truerte/1/custom-toggle-toolbar-button/">
     ...
     * <a href="https://www.truerte.org/docs/truerte/1/custom-group-toolbar-button/">
     ...
     * <a href="https://www.truerte.org/docs/truerte/1/custom-toggle-menu-items/">
