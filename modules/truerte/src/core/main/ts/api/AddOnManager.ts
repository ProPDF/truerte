...
/**
 * TrueRTE theme pseudo class. Allows for a custom theme to be used with TrueRTE when registered using the ThemeManager.
 *
 * @summary This is a pseudo class that describes how to create a custom theme for TrueRTE.
 * <br><br>
 * See AddOnManager for more information about the methods available on the ThemeManager instance.
 * <br><br>
 * <strong>Warning</strong>: Much of TrueRTE's functionality is provided by the default Silver theme.
 * Creating a custom theme may require the re-implementation of this functionality.
 * To change TrueRTE's appearance, we recommend changing the Skin instead.
 *
 * @class truerte.Theme
 * @example
 * truerte.ThemeManager.add('MyTheme', (editor) => {
...
/**
 * TrueRTE plugin psuedo class. Allows for custom plugins to be added to TrueRTE when registered using the PluginManager.
 *
 * @summary This is a pseudo class that describes how to create a custom plugin for TrueRTE.
 * <br><br>
 ...
 *
 * @class truerte.Plugin
 * @example
 * truerte.PluginManager.add('MyPlugin', (editor, url) => {
...
const AddOnManager = <T>(): AddOnManager<T> => {
  ...
  return {
     ...
     * @return {truerte.Theme/truerte.Plugin} Theme or plugin add-on instance or undefined.
     */
    get,
     ...
     * @param {truerte.Theme/truerte.Plugin} addOn Theme or plugin to add.
     * @return {truerte.Theme/truerte.Plugin} The same theme or plugin instance that got passed in.
     * @example
     ...
     * truerte.PluginManager.add('test', TestPlugin);
     *
     * // Initialize TrueRTE
     * truerte.init({
     *   ...
     ...
     * truerte.PluginManager.load('myplugin', '/some/dir/someplugin/plugin.js');
     *
     * // Initialize TrueRTE
     * truerte.init({
     *   ...
