 ...
 *
 * @class truerte.html.Node
 * @version 3.4
 * @example
 * const node = new truerte.html.Node('strong', 1);
...
class AstNode {
   ...
   *
   * @method replace
   * @param {truerte.html.Node} node Node to replace the current node with.
   * @return {truerte.html.Node} The old node that got replaced.
   * @example
   ...
   * @return {String/truerte.html.Node} String or undefined on a get operation or the current node on a set operation.
   * @example
   ...
   *
   * @method clone
   * @return {truerte.html.Node} New copy of the original node.
   * @example
   ...
   *
   * @method remove
   * @return {truerte.html.Node} Current node that got removed.
   * @example
   * node.remove();
   */
   ...
   *
   * @method append
   * @param {truerte.html.Node} node Node to append as a child of the current one.
   * @return {truerte.html.Node} The node that got appended.
   * @example
   ...
   *
   * @method insert
   * @param {truerte.html.Node} node Node to insert as a child of this node.
   * @param {truerte.html.Node} refNode Reference node to set node before/after.
   * @param {Boolean} before Optional state to insert the node before the reference node.
   * @return {truerte.html.Node} The node that got inserted.
   * @example
   ...
   *
   * @method empty
   * @return {truerte.html.Node} The current node that got cleared.
   */
   ...
   * @return {truerte.html.Node} Node that is next to or previous of the current node.
   */
