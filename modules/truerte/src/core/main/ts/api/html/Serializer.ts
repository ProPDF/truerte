 ...
 *
 * @class truerte.html.Serializer
 * @version 3.4
 * @example
 * truerte.html.Serializer().serialize(truerte.html.DomParser().parse('<p>text</p>'));
 */
...
const HtmlSerializer = (settings: HtmlSerializerSettings = {}, schema: Schema = Schema()): HtmlSerializer => {
   ...
   *
   * @method serialize
   * @param {truerte.html.Node} node Node instance to serialize.
