 ...
 * directly on the truerte namespace.
 *
 * @class truerte.util.Tools
 */
 ...
 * const obj = truerte.resolve('a.b.c.d');
 */
 ...
 * const arr = truerte.explode('a, b,   c');
 */
...
const Tools: Tools = {
   ...
   * @example
   * // Iterate an array
   * truerte.each([ 1,2,3 ], (v, i) => {
   *   console.debug("Value: " + v + ", Index: " + i);
   * });
   *
   * // Iterate an object
   * truerte.each({ a: 1, b: 2, c: 3 }, (v, k) => {
   ...
   * const items = truerte.grep([ 1,2,3,4,5 ], (v) => v > 3);
   */
