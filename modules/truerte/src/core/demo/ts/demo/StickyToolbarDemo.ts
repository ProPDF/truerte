...
import { Editor, RawEditorOptions, TrueRTE } from 'truerte/core/api/PublicApi';
...
export default (): void => {
  ...
  truerte.init(stickySettings);
  truerte.init({ ...stickySettings, inline: true, selector: '.truerte' });
};
