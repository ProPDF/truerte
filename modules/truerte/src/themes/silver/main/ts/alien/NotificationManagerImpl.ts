...
import { NotificationApi, NotificationManagerImpl, NotificationSpec } from 'truerte/core/api/NotificationManager';
import Delay from 'truerte/core/api/util/Delay';
...
export default (editor: Editor, extras: Extras, uiMothership: Gui.GuiSystem): NotificationManagerImpl => {
  ...
  const getBounds = () => {
     ...
     *
     * Note: This isn't perfect, but we have a plan to fix it now that TrueRTE 6 removed public methods restricting
