...
// import { Logo } from 'truerte/themes/silver/resources/StatusbarLogo';
      ...
      components: [
        {
          dom: {
            tag: 'a',
            attributes: {
              href: 'https://truerte.org/powered-by-truerte?utm_campaign=poweredby&utm_source=editor&utm_medium=referral&utm_content=v1',
              rel: 'noopener',
              target: '_blank',
            },
            innerHtml: I18n.translate([ 'Powered by {0}', 'TrueRTE' ]),
          },
