...
import CharmapPlugin from 'truerte/plugins/charmap/Plugin';
import EmoticonsPlugin from 'truerte/plugins/emoticons/Plugin';

import * as TooltipUtils from '../../../module/TooltipUtils';

describe('browser.truerte.themes.silver.editor.CollectionTooltipTest', () => {
