...
import SavePlugin from 'truerte/plugins/save/Plugin';
import SearchReplacePlugin from 'truerte/plugins/searchreplace/Plugin';

import * as TooltipUtils from '../../../module/TooltipUtils';

describe('browser.truerte.themes.silver.editor.TooltipShortcutTest', () => {
