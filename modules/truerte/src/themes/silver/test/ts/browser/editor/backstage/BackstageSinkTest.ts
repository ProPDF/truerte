...
import * as Backstage from 'truerte/themes/silver/backstage/Backstage';
import * as Options from 'truerte/themes/silver/ui/core/color/Options';

describe('browser.truerte.themes.silver.editor.backstage.BackstageSinkTest', () => {
