...
describe('browser.truerte.themes.silver.editor.contextmenu.CustomContextMenuTest', () => {
  ...
  context('Multiple empty context menus', () => {
    ...
    it('TINY-9842: Multiple empty custom context menus should fallback to native context menu', () => {
      ...
      UiFinder.exists(SugarBody.body(), '.tox.tox-silver-sink.tox-truerte-aux:empty');
    });
  });
});
