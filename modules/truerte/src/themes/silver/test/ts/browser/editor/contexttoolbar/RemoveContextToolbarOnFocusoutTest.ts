...
describe.skip('browser.truerte.themes.silver.editor.contexttoolbar.RemoveContextToolbarOnFocusoutTest', () => {
  ...
  it('iframe editor focusout should remove context toolbar', async () => {
    const editor = await McEditor.pFromHtml<Editor>(html, { setup, base_url: '/project/truerte/js/truerte' });
    editor.focus();
  ...
  it('inline editor focusout should remove context toolbar', async () => {
    const editor = await McEditor.pFromHtml<Editor>(html, { setup, inline: true, base_url: '/project/truerte/js/truerte' });
    editor.focus();
