...
describe('browser.truerte.themes.silver.editor.SilverFixedToolbarContainerTargetTest', () => {
  ...
  it('Check fixed_toolbar_container_target setting for inline editor', async () => {
    ...
    Assertions.assertPresence('Check that the inline toolbar exists', { '.tox-truerte-inline': 1 }, SugarBody.body());
  });
});
