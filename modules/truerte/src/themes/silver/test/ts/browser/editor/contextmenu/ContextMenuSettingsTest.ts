...
import * as Options from 'truerte/themes/silver/ui/menus/contextmenu/Options';

describe('browser.truerte.themes.silver.editor.contextmenu.ContextMenuSettingsTest', () => {
