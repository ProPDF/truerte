...
import { formatSize } from 'truerte/themes/silver/ui/sizeinput/SizeInputModel';

describe('atomic.truerte.themes.silver.components.sizeinput.SizeInputFormatTest', () => {
