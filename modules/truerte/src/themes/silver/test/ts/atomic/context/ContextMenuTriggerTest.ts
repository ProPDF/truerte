...
import { isTriggeredByKeyboard } from 'truerte/themes/silver/ui/menus/contextmenu/SilverContextMenu';

describe('atomic.truerte.themes.silver.context.ContextMenuTriggerTest', () => {
