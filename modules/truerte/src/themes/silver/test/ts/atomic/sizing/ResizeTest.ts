...
import { getDimensions, ResizeTypes } from 'truerte/themes/silver/ui/sizing/Resize';
import * as Utils from 'truerte/themes/silver/ui/sizing/Utils';
...
describe('atomic.truerte.themes.silver.sizing.ResizeTest', () => {
