...
import { ImagePreviewDataSpec, renderImagePreview } from 'truerte/themes/silver/ui/dialog/ImagePreview';

describe('headless.truerte.themes.silver.components.imagepreview.BasicImagePreviewTest', () => {
