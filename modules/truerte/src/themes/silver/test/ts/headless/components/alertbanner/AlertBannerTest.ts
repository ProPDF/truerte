...
import { renderAlertBanner } from 'truerte/themes/silver/ui/general/AlertBanner';

import TestProviders from '../../../module/TestProviders';

describe('headless.truerte.themes.silver.components.alertbanner.AlertBannerTest', () => {
  const providers = {
    ...TestProviders,
