...
import { renderToolbar, renderToolbarGroup } from 'truerte/themes/silver/ui/toolbar/CommonToolbar';

import TestProviders from '../../module/TestProviders';

describe('headless.truerte.themes.silver.toolbar.ToolbarTest', () => {
