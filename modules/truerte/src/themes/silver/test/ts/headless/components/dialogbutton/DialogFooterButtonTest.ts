...
import { renderFooterButton } from 'truerte/themes/silver/ui/general/Button';

import TestBackstage from '../../../module/TestBackstage';

describe('headless.truerte.themes.silver.components.dialogbutton.DialogFooterButtonTest', () => {
