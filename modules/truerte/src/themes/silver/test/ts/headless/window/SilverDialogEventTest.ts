...
import { UiFactoryBackstage, UiFactoryBackstageProviders } from 'truerte/themes/silver/backstage/Backstage';
import { renderDialog } from 'truerte/themes/silver/ui/window/SilverDialog';

describe('headless.truerte.themes.silver.window.SilverDialogEventTest', () => {
