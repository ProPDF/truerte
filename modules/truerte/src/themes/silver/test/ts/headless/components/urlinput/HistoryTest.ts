...
import { addToHistory, clearHistory, getHistory } from 'truerte/themes/silver/backstage/UrlInputHistory';

describe('headless.truerte.themes.silver.components.urlinput.HistoryTest', () => {
