...
import { SimpleBehaviours } from 'truerte/themes/silver/ui/alien/SimpleBehaviours';
import { onControlAttached, onControlDetached } from 'truerte/themes/silver/ui/controls/Controls';

describe('headless.truerte.themes.silver.configs.ControlOnSetup Test', () => {
