...
import { WindowManagerImpl } from 'truerte/core/api/WindowManager';
import * as WindowManager from 'truerte/themes/silver/ui/dialog/WindowManager';

import * as TestExtras from '../../module/TestExtras';

describe('headless.truerte.themes.silver.window.SilverUrlDialogTest', () => {
  ...
  const openDialog = () => {
    dialogApi = windowManager.openUrl({
      ...
      url: '/project/truerte/src/themes/silver/test/html/iframe.html',
      buttons: [
        {
          type: 'custom',
          name: 'barny',
