...
// This would be part of the truerte api under editor.ui.* so editor.ui.addButton('bold', ...)
// TODO: This should maybe not be part of this project but rather something built into truerte core using these public types
